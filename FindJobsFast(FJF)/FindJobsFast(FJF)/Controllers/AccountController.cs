using FindJobsFast_FJF_.Messaging;
using FindJobsFast_FJF_.Models;
using FindJobsFast_FJF_.Providers;
using FindJobsFast_FJF_.Results;
...
namespace FindJobsFast_FJF_.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            string email = "admin@cyberspace.com";
            string password = "Pa66w0rd?";
            string role = "ADMIN";
